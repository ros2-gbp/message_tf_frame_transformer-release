...
%global pkg_name message_tf_frame_transformer
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-message-tf-frame-transformer
Version:        1.1.3
Release:        4%{?dist}
...
%changelog
* Thu Jul 09 2026 Lennart Reiher <lennart.reiher@rwth-aachen.de> - 1.1.3-4
- Autogenerated by Bloom

* Wed Apr 29 2026 Lennart Reiher <lennart.reiher@rwth-aachen.de> - 1.1.3-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Lennart Reiher <lennart.reiher@rwth-aachen.de> - 1.1.3-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Lennart Reiher <lennart.reiher@rwth-aachen.de> - 1.1.3-1
- Autogenerated by Bloom
